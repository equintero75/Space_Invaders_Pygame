...
spaceship = Actor('resized_spaceship', (300, 740))  # Use resized image
missiles = []  # Corrected typo
meteors = []
...
def on_key_down(key):
    ...
    if game_state == "NEW_GAME" and key == keys.S:
        ...
        missile = Actor('resized_spacemissiles', (spaceship.x, spaceship.top))  # Use resized image
